 ...
 */
class Lemric_Sail_Tests_Fixtures_TestKernelTestDebugContainer extends Container
{
    protected $targetDir;
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/Lemric_Sail_Tests_Fixtures_TestKernelTestDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'Lemric_Sail_Tests_Fixtures_TestKernelTestDebugContainer',
